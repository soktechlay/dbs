            ...
            <ul class="navbar-nav ms-auto d-flex flex-row align-items-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="#" class="list-group-item list-group-item-action">
                                ...
                                <p class="mb-1">Change deprecated html tags to text decoration classes (#29604)</p>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                                    <h6 class="mb-1">Example 2</h6>
                                    <small>10 min ago</small>
                                </div>
                                <p class="mb-1">justify-content:between ⇒ justify-content:space-between (#29734)</p>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                                    <h6 class="mb-1">Example 3</h6>
                                    <small>30 min ago</small>
                                </div>
                                <p class="mb-1">Update change-version.js (#29736)</p>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                                    <h6 class="mb-1">Example 4</h6>
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex align-items-center" data-bs-toggle="dropdown"
                        ...
                        <img src="<?php echo htmlspecialchars($_SESSION['admin_profile'] ); ?>"
                        ...
                        <div class="d-none d-xl-block">
                            ...
                            <small class="text-secondary">UI Designer</small>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
